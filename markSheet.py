...
def get_grade(o_m) :
    ...
    if o_m < 40 :
        return "F"
print("+"+"-"*20+"+"+"-"*20+"+"+"-"*15+"+"+"-"*15+"+")
print("| Subjects"+" "*11+"| Obtain Marks"+" "*7+"| Total Marks"+" "*3+"| Grade"+" "*9+"|")
print("+"+"-"*20+"+"+"-"*20+"+"+"-"*15+"+"+"-"*15+"+")
#   Percentage of English
p_english = (int(english_marks) / 75) * 100
g_english = get_grade(p_english)
print("| English"+" "*12+f"| {english_marks}"+" "*17+"| 75"+" "*12+f"| {g_english}")
print("+"+"-"*20+"+"+"-"*20+"+"+"-"*15+"+"+"-"*15+"+")
#   Percentage of Urdu 
p_urdu = (int(urdu_marks) / 100) * 100
g_urdu = get_grade(p_urdu)
print("| Urdu"+" "*15+f"| {urdu_marks}"+" "*17+"| 100"+" "*11+f"| {g_urdu}")
print("+"+"-"*20+"+"+"-"*20+"+"+"-"*15+"+"+"-"*15+"+")
#   Percentage of Maths 
p_maths = (int(maths_marks) / 100) * 100
g_maths = get_grade(p_maths)
print("| Maths"+" "*14+f"| {maths_marks}"+" "*17+"| 100"+" "*11+f"| {g_maths}")
print("+"+"-"*20+"+"+"-"*20+"+"+"-"*15+"+"+"-"*15+"+")
#   Percentage of Chemistry
p_chemistry = (int(chemistry_marks) / 100) * 100
g_chemistry = get_grade(p_chemistry)
print("| Chemistry"+" "*10+f"| {chemistry_marks}"+" "*17+"| 100"+" "*11+f"| {g_chemistry}")
print("+"+"-"*20+"+"+"-"*20+"+"+"-"*15+"+"+"-"*15+"+")
#   Percentage of Physics
p_physics = (int(physics_marks) / 100) * 100
g_physics = get_grade(p_physics)
print("| physics"+" "*12+f"| {physics_marks}"+" "*17+"| 100"+" "*11+f"| {g_physics}")
print("+"+"-"*20+"+"+"-"*20+"+"+"-"*15+"+"+"-"*15+"+")
print(f"Total Number {int(english_marks)+int(urdu_marks)+int(maths_marks)+int(chemistry_marks)+int(physics_marks)} out of 475")
print(f"Total Percentage: {(p_english+p_urdu+p_maths+p_chemistry+p_physics)/5} %")
print(f"Grade: {get_grade((p_english+p_urdu+p_maths+p_chemistry+p_physics)/5)}")